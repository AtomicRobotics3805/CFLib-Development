 ...
 */
@Autonomous(name = "Testing Autonomous OpMode")
class TestingAutonomousOpMode : AutonomousOpMode(
    Constants.Color.BLUE,
    TestingTrajectoryFactory,
    { TestingRoutines.voltageSpikeTest },
    null,
    MecanumDrive(
        TestingMecanumDriveConstants,
        TwoWheelOdometryLocalizer(TestingOdometryConstants)
    ) { Pose2d() },
    TestingLift, TestingClaw
)